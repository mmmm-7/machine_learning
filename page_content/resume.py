...
def resume_page():
    ...
    st.markdown("""
    - **Email:** 1155216003@link.cuhk.edu.hk
    - **Phone:** (852) 5644 8759
    ...
    st.markdown("""
    **Marketing Intern, Chinese Arts & Crafts **
    ...
    **Public relations intern, Hill+Knowlton Strategies**
    ...
    **Bachelor of Art in Internatioanl Business Communication**
